...
def findFilename(animal, date, expt="*", session="*", extension="h5", 
    ...
    if False:
        ...
        print(f"{fdir}/{date}_*_{expt}_{animal}_{session}.{extension}")
        fname_search = f"{fdir}/{date}_*_{expt}_{animal}_{session}.{extension}"
        fnames = glob.glob(fname_search)
...
def loadSingleData(animal, date, expt, session, resave_as_dict=False, 
    ...
    updateFiledataParams(filedata, animal)
...
def updateFiledataParams(filedata, animal):
    ...
    filedata["params"]["basedir"] = f"{BASEDIR}/{animal}"
    filedata["params"]["figuredir"] = f"{BASEDIR}/{date}/figures/{filedata['params']['session']}"
    filedata["params"]["figuredir_general"] = f"{BASEDIR}/{date}/figures"
