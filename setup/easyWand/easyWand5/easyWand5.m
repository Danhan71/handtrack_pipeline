...
uda.handles.camTable = uitable(...
  ...
  'ColumnName',{  '<HTML><FONT size=2>Cam';...
  '<HTML><FONT color="blue" size=2><strong>Primary'; ...
  '<HTML><FONT color="blue" size=2><strong>Image Width (px)';...
  '<HTML><FONT color="blue" size=2><strong>Image Height (px)';...
  '<HTML><FONT color="blue" size=2><strong>FL Estimate (px)';...
  '<HTML><FONT size=2>Prin. Point X (px)'; ...
  '<HTML><FONT size=2>Prin. Point Y (px)';...
  '<HTML><FONT size=2>FL Calculated (px)';...
  '<HTML><FONT size=2>Prin. Pt. Calc. (X)';...
  '<HTML><FONT size=2>Prin. Pt. Calc. (Y)';...
  '<HTML><FONT size=2>DLT Reproj. Err. (px)';...
  '<HTML><FONT size=2>Pos. X (m)';...
  '<HTML><FONT size=2>Pos. Y (m)';...
  '<HTML><FONT size=2>Pos. Z (m)' },...
...
uda.handles.editMain= figure('Units','characters',... % control figure
  ...
  'Position',[posX posY screenwidth screentop],'Resize','on',...
...
%   'IntegerHandle','off','MenuBar','none',...
%   'Name','Edit Wizard','NumberTitle','off',...
%   'Position',[0 0 2*screenwidth 2*screentop],'Resize','on',...
%   'HandleVisibility','callback','Tag','editMain',...
%   'UserData',uda,'Visible','on','deletefcn','',...
%   'interruptible','on'); %,'WindowStyle','modal'
...
uda.handles.cameraEditLabel = uicontrol('Parent',uda.handles.editMain,...
  'Units','characters','Position',[width+10 screentop-y+3 40 3],'Style',...
  'text','BackgroundColor',backColor,'string',...
...
uda.handles.cameraEditLabel = uicontrol('Parent',uda.handles.editMain,...
  'Units','characters','Position',[width+50 screentop-y+3 40 3],'Style',...
  'text','BackgroundColor',backColor,'string',...
...
uda.handles.cameraChoiceMenu = uicontrol('Parent',uda.handles.editMain,...
  'Units','characters','Position',[width+10 screentop-y+3 30 4],...
...
uda.handles.fbChoiceMenu = uicontrol('Parent',uda.handles.editMain,'Units','characters','Position',...
  [width+50 screentop-y+3 30 4],'String',fbMenu,'Style','popupmenu',...
...
uda.handles.axes2 = axes(...
  'Units','characters',...
  'Position',[width+6 screentop-y+7 screenwidth-width-8 axesheight],...
  'CameraPosition',[0.5 0.5 9.16],...
  'CameraPositionMode',get(0,'defaultaxesCameraPositionMode'),...
  'Color',get(0,'defaultaxesColor'),...
  'ColorOrder',get(0,'defaultaxesColorOrder'),...
