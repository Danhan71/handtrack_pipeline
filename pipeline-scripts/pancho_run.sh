...
# dates=(231114)
# dates=(220618 220626 220630 230125 230119 230120 230126 230127 220616 220621 220622 220624 220614)
# dates=(220618)
dates=(230125 230120)
animal="Pancho"
...
do
    ...
    taskset -a -c 0-9 nohup ../notrain_run_script.sh -e ${i} -b -a ${animal} --loop -${dir_type} --ploton > ./logs/${animal}/${i}.log 2>&1 &
    wait
